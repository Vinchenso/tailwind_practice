<template>
  <div class='font-source-sans font-normal leading-normal'>
    ...
    <div class="border-b border-grey-light p-4 ">
      <div>
        <div class="bg-teal-lightest border-t-4 border-teal rounded-b shadow-md text-teal-darkest px-4 py-3">
    ...
    <div class="border-b border-grey-light p-4 flex justify-center">
